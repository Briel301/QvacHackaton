...
export function stoppedByLength({ cancelled, effectivePredict, generatedTokens, stoppedAtContextBoundary }) {
    if (cancelled)
        return false;
    if (stoppedAtContextBoundary)
        return true;
    return (effectivePredict !== undefined &&
        effectivePredict > 0 &&
        generatedTokens !== undefined &&
