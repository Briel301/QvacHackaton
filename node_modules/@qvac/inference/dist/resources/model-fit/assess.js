...
export function assessModelFitFromResources(options) {
    ...
    const evaluated = models.map((candidate) => evaluate(candidate, platform, effectiveCalibration, resources, resolveProfile, gpuMode));
...
function evaluate(candidate, platform, calibration, resources, resolveProfile, gpuMode) {
    if (!calibration) {
        return {
            candidate,
            result: {
