import type { GgufFacts } from '../../../schemas/model-resource-profile.js';
import type { ByteRange, EstimatorInput, EstimatorResult } from '../types.js';
export declare const LLM_ESTIMATOR_VERSION = "llm-v1";
/**
 ...
 */
export declare function estimateLlm(input: EstimatorInput): EstimatorResult;
 ...
 *   assumptions array.
 */
export declare function kvElementBytes(facts: GgufFacts, hasGpu: boolean): KvElementWidth;
/**
 ...
 */
export declare function kvCacheBytesForWidth(facts: GgufFacts, contextTokens: number, bytesPerElement: number): ByteRange;
