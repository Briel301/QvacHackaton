...
import { assessModelFit, getSystemResources, loadModel, unloadModel, completion, close, QWEN3_600M_INST_Q4, QWEN3_1_7B_INST_Q4, QWEN3_4B_INST_Q4_K_M, QWEN3_8B_INST_Q4_K_M, QWEN3_8_27B_MULTIMODAL_UD_Q8_K_XL } from '@qvac/sdk';
const PORT = 8712;
...
async function estimate(body) {
    ...
    const workload = { kind: 'llm', contextTokens };
...
const server = createServer((request, response) => {
    ...
    if (request.method === 'GET' && url === '/api/models') {
        sendJson(response, 200, CATALOG.map((model) => ({ name: model.name, expectedSize: model.expectedSize })));
        return;
    }
