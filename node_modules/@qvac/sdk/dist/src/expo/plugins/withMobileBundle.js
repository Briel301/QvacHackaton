...
import { getProjectRootFromMod } from './get-project-root.js';
import { findInAncestorNodeModules } from './find-in-ancestor-node-modules.js';
...
async function runIOSAddonLinker(linkerPath) {
    await new Promise((resolve, reject) => {
        ...
        proc.on('close', (code) => {
            ...
            reject(new Error(`QVAC: iOS native addon linker exited with code ${code ?? 1}${details ? `: ${details}` : ''}`));
        });
